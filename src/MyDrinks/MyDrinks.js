  ...
  const drinks = myDrink.map((drink1) => {
    return (
      <>
          ...
          <div className="card-body">
            <div className="d-block d-md-flex">
              <div className="p-3 flex-1">
                ...
                <p align="justify">
                  {drink1.strIngredient1}
                  <br></br>
                  {drink1.strIngredient2}
                  <br></br>
                  {drink1.strIngredient3}
                  <br></br>
                  {drink1.strIngredient4}
                  <br></br>
                  {drink1.strIngredient5}
                  <br></br>
                  {drink1.strIngredient6}
                  <br></br>
                  {drink1.strIngredient7}
                </p>
              </div>
        ...
        <div>
          <p className="p-Button1">
            <button
              type="button"
              className="btn btn-secondary btn-sm"
              onClick={() => {
                console.log(
                  myDrink.indexOf(drink1),
                  setRemoveDrink(myDrink.indexOf(drink1)),
                  removeDrinks()
                );
              }}
            >
              Remove from your Drinks -
            </button>
          </p>
        </div>
      </>
